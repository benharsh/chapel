...
uint64RepeatedAppend(lst1, 1, f.writer(serializer=new BinarySerializer(ioendian.little), locking=false));
var r = f.reader(deserializer=new BinaryDeserializer(ioendian.little), locking=false);
...
lst2.pushBack(1);
lst2.pushBack(24454);
uint32RepeatedAppend(lst2, 1, f.writer(serializer=new BinarySerializer(ioendian.little), locking=false));
r = f.reader(deserializer=new BinaryDeserializer(ioendian.little), locking=false);
writeln(tagConsume(r) == (1, lengthDelimited)); // Check for fieldNumber and wireType
...
int64RepeatedAppend(lst3, 1, f.writer(serializer=new BinarySerializer(ioendian.little), locking=false));
r = f.reader(deserializer=new BinaryDeserializer(ioendian.little), locking=false);
writeln(tagConsume(r) == (1, lengthDelimited)); // Check for fieldNumber and wireType
...
int32RepeatedAppend(lst4, 1, f.writer(serializer=new BinarySerializer(ioendian.little), locking=false));
r = f.reader(deserializer=new BinaryDeserializer(ioendian.little), locking=false);
writeln(tagConsume(r) == (1, lengthDelimited)); // Check for fieldNumber and wireType
...
lst5.pushBack(true);
lst5.pushBack(false);
boolRepeatedAppend(lst5, 1, f.writer(serializer=new BinarySerializer(ioendian.little), locking=false));
r = f.reader(deserializer=new BinaryDeserializer(ioendian.little), locking=false);
writeln(tagConsume(r) == (1, lengthDelimited)); // Check for fieldNumber and wireType
...
sint32RepeatedAppend(lst6, 1, f.writer(serializer=new BinarySerializer(ioendian.little), locking=false));
r = f.reader(deserializer=new BinaryDeserializer(ioendian.little), locking=false);
writeln(tagConsume(r) == (1, lengthDelimited)); // Check for fieldNumber and wireType
...
sint64RepeatedAppend(lst7, 1, f.writer(serializer=new BinarySerializer(ioendian.little), locking=false));
r = f.reader(deserializer=new BinaryDeserializer(ioendian.little), locking=false);
writeln(tagConsume(r) == (1, lengthDelimited)); // Check for fieldNumber and wireType
...
bytesRepeatedAppend(lst8, 1, f.writer(serializer=new BinarySerializer(ioendian.little), locking=false));
r = f.reader(deserializer=new BinaryDeserializer(ioendian.little), locking=false);
lst8.clear();
lst8.pushBack(b"\x01\x87\x76");
writeln(tagConsume(r) == (1, lengthDelimited)); // Check for fieldNumber and wireType
...
stringRepeatedAppend(lst9, 1, f.writer(serializer=new BinarySerializer(ioendian.little), locking=false));
r = f.reader(deserializer=new BinaryDeserializer(ioendian.little), locking=false);
lst9.clear();
lst9.pushBack("aniket");
writeln(tagConsume(r) == (1, lengthDelimited)); // Check for fieldNumber and wireType
...
lst10.pushBack(67);
lst10.pushBack(8907);
fixed32RepeatedAppend(lst10, 1, f.writer(serializer=new BinarySerializer(ioendian.little), locking=false));
r = f.reader(deserializer=new BinaryDeserializer(ioendian.little), locking=false);
writeln(tagConsume(r) == (1, lengthDelimited)); // Check for fieldNumber and wireType
...
fixed64RepeatedAppend(lst11, 1, f.writer(serializer=new BinarySerializer(ioendian.little), locking=false));
r = f.reader(deserializer=new BinaryDeserializer(ioendian.little), locking=false);
writeln(tagConsume(r) == (1, lengthDelimited)); // Check for fieldNumber and wireType
...
floatRepeatedAppend(lst12, 1, f.writer(serializer=new BinarySerializer(ioendian.little), locking=false));
r = f.reader(deserializer=new BinaryDeserializer(ioendian.little), locking=false);
writeln(tagConsume(r) == (1, lengthDelimited)); // Check for fieldNumber and wireType
...
doubleRepeatedAppend(lst13, 1, f.writer(serializer=new BinarySerializer(ioendian.little), locking=false));
r = f.reader(deserializer=new BinaryDeserializer(ioendian.little), locking=false);
writeln(tagConsume(r) == (1, lengthDelimited)); // Check for fieldNumber and wireType
...
sfixed32RepeatedAppend(lst14, 1, f.writer(serializer=new BinarySerializer(ioendian.little), locking=false));
r = f.reader(deserializer=new BinaryDeserializer(ioendian.little), locking=false);
writeln(tagConsume(r) == (1, lengthDelimited)); // Check for fieldNumber and wireType
...
sfixed64RepeatedAppend(lst15, 1, f.writer(serializer=new BinarySerializer(ioendian.little), locking=false));
r = f.reader(deserializer=new BinaryDeserializer(ioendian.little), locking=false);
writeln(tagConsume(r) == (1, lengthDelimited)); // Check for fieldNumber and wireType
